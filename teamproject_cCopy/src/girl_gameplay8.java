...
public class girl_gameplay8 {
	...
	public static void show() {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					girl_gameplay8 window = new girl_gameplay8();
	...
	private void initialize() {
		...
		girl_division_Label.setBounds(12, 10, 139, 35);
		frame.getContentPane().add(girl_division_Label);
		
		JLabel eghit_label = new JLabel("[8\uAC15]");
		eghit_label.setFont(new Font("굴림", Font.PLAIN, 25));
		eghit_label.setBounds(647, 12, 62, 35);
		frame.getContentPane().add(eghit_label);
	}
}
